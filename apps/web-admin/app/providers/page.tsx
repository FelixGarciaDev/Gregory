    ...
    <main className="page-shell">
      <section className="hero hero-with-toolbar">
        <div>
          ...
          <h1>Providers</h1>
          <p className="lede">Review providers and jump into the dedicated flows to create providers or provider users.</p>
        </div>
      ...
      <section className="providers-list">
        <div className="section-heading">
          ...
          <p className="section-copy">Admins can verify which provider accounts are already attached before creating more.</p>
        </div>

        <div className="grid providers-layout">
          {providers.length === 0 ? (
            <article className="panel">
              <p className="section-copy">No providers yet. Use the add provider flow to create the first one.</p>
            </article>
          ) : (
